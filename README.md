...
│  (Next.js)      │   ws://pi:19800    │  (Go)            │   2400bps 7E1     │  HV-60KCWP-K│
...
| プリンタ | なし | Brother QL-800 (CUPS/lp) |
| print_test | なし | あり |
...
| BrotherPrinterDriver | **基本実装** | `TestPrint()` のみ。ラベル印刷は未実装 |
...
└── internal/
    ...
    ├── printer/
    │   └── brother.go              # Brother QL-800 ドライバ（CUPS lp コマンド）
    └── ws/
...
# CUPS Web UI: http://localhost:631/admin → Add Printer → Brother QL-800
